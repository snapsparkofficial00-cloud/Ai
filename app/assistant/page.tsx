...
try {
  ...
  if (
    finalCommand.toLowerCase().includes("youtube") ||
    finalCommand.toLowerCase().includes("shorts") ||
    finalCommand.toLowerCase().includes("viral")
  ) {
  ...
  if (
    finalCommand.toLowerCase().includes("instagram") ||
    finalCommand.toLowerCase().includes("reels")
  ) {
  ...
  /* WEBSITE AI */
    ...
    finalCommand.toLowerCase().includes("website") ||
    finalCommand.toLowerCase().includes("web")
  ) {
  ...
  /* REVENUE AI */
    ...
    finalCommand.toLowerCase().includes("revenue") ||
    finalCommand.toLowerCase().includes("money")
  ) {
...
>
  ...
  >
    Autonomous AI infrastructure controlling
    all business systems, automation workflows,
    analytics, memory intelligence and growth.
  </p>
