"use strict";(()=>{var e={};e.id=972,e.ids=[972],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6989:(e,t,s)=>{s.r(t),s.d(t,{originalPathname:()=>k,patchFetch:()=>v,requestAsyncStorage:()=>A,routeModule:()=>y,serverHooks:()=>w,staticGenerationAsyncStorage:()=>f});var a={};s.r(a),s.d(a,{POST:()=>S});var n=s(9303),r=s(8716),o=s(670),i=s(7070);class u{send(e,t,s){let a={from:e,to:t,message:s,timestamp:new Date};return this.messages.unshift(a),console.log(`[BUS]
${e} -> ${t}:
...
${e}`),{success:!0,goal:e,tasks:t}}var p=s(8357);class d{addTask(e,t){let s={id:crypto.randomUUID(),agent:e,input:t,status:"pending"};return this.queue.push(s),this.process(),s}async process(){if(!this.running){for(this.running=!0;this.queue.length>0;){let e=this.queue[0];try{e.status="running",await p.Z.createTask(e.agent,e.input),e.status="completed"}catch{e.status="failed"}this.queue.shift()}this.running=!1}}getQueue(){return this.queue}constructor(){this.queue=[],this.running=!1}}let g=new d;async function m(e){return console.log("Playwright disabled in production"),{success:!1}}async function h(e){let t=[];for(let s of e){console.log("Queueing task:",s),g.addTask(s.agent,s.input),t.push({queued:!0,task:s});try{await m({agent:s.agent,input:s.input}),console.log("Task executed:",s.input)}catch(e){console.log("Execution failed:",e)}}return{success:!0,queued:t,total:t.length}}async function S(e){try{let t=await e.json(),s=await l(t.goal),a=await h(s.tasks);return i.NextResponse.json({success:!0,goal:t.goal,plan:s,execution:a})}catch(e){return console.log(e),i.NextResponse.json({success:!1,error:"Execution failed"})}}let y=new n.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/api/execute/route",pathname:"/api/execute",filename:"route",bundlePath:"app/api/execute/route"},resolvedPagePath:"/workspaces/Ai/app/api/execute/route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:A,staticGenerationAsyncStorage:f,serverHooks:w}=y,k="/api/execute/route";function v(){return(0,o.patchFetch)({serverHooks:w,staticGenerationAsyncStorage:f})}},5912:(e,t,s)=>{s.d(t,{B7:()=>n,yr:()=>r});let a=[];function n(e,t,s){a.unshift({id:crypto.randomUUID(),time:new Date,agent:e,type:t,message:s})}function r(){return a}},8182:(e,t,s)=>{async function a(e){try{return await fetch(`${process.env.NEXT_PUBLIC_SUPABASE_URL}/rest/v1/memory`,{method:"POST",headers:{apikey:process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY,Authorization:`Bearer ${process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY}`,"Content-Type":"application/json",Prefer:"return=minimal"},body:JSON.stringify({agent:e.agent,message:e.message,response:e.response,created_at:new Date})}),{success:!0}}catch(e){return console.log("MEMORY ERROR:",e),{success:!1}}}async function n(){try{let e=await fetch(`${process.env.NEXT_PUBLIC_SUPABASE_URL}/rest/v1/memory?select=*`,{headers:{apikey:process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY,Authorization:`Bearer ${process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY}`}});return await e.json()}catch(e){return console.log(e),[]}}s.d(t,{N:()=>n,j:()=>a})},8357:(e,t,s)=>{s.d(t,{Z:()=>i});var a=s(8182),n=s(5912);async function r(e,t){(0,n.B7)(e,"INFO",`Task started:
